...
{
    public class InstructorController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async System.Threading.Tasks.Task<ActionResult> EditAsync(int? id, string[] selectedCourses)
        {
            if (id == null)
            {
                //return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
