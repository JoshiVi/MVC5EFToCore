...
namespace ContosoUniversity.Controllers
{
    public class StudentController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        public ViewResult Index(string sortOrder, string currentFilter, string searchString, int? page)
        {
            ...
            //PagedList.Core.IPagedList
            //X.PagedList.PagedList`
            //X.PagedList.PagedList
            //students.ToPagedList

            //var s = (X.PagedList.PagedList) students.ToPagedList(pageNumber, pageSize);
        ...
        public async System.Threading.Tasks.Task<ActionResult> EditPostAsync(int? id)
        {
            ...
            if (await TryUpdateModelAsync(studentToUpdate, "", s => s.LastName, s => s.FirstMidName, s => s.EnrollmentDate))
            {
                try
                {
                    db.SaveChanges();
